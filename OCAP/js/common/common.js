var config = {
    baseUrl: 'http://10.89.165.115/ApiForOCAPNew/api/',
    // baseUrl: 'http://localhost:5611/api/',
    ftpUrl: 'ftp://qhdqafile:asd0.1234%2B-*%2F@10.86.16.96/qhdqafile/OCAP/ALL/',
    ...
    menu: [
        {
            name: '1',
            title: '異常查詢',
            to: '../OCAPList/index.html'
        },
        {
            name: '3',
            title: '統計報表',
            to: '../OCAPSummary/index.html'
        },
        {
            name: '2',
            title: 'HL人員維護',
            to: '../HLList/index.html'
        },
    ]
}
